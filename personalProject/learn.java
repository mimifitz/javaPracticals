...
public class learn {
    public static void main(String[] args) {
        ...
        // byte mimi = 45;
        // byte david = mimi;
        // mimi = 67;// reasssignng this doesn't affect david. davd will be 45. both completely
     ...
     //both variables are pointing to the same values. they are referencing the same vlaue.
